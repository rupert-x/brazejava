...
### Export User Profile by Identifier <a name="create"></a>
...
**API Endpoint**: `POST /users/export/ids`

#### Parameters

| Parameter | Required | Description | Example |
|-----------|:--------:|-------------|--------|
| `data` | ✗ |  | `UsersExportIdsCreateBody.builder().brazeId("braze_identifier").deviceId("1234567").emailAddress("example@braze.com").externalIds(List.of("user_identifier1","user_identifier2")).fieldsToExport(List.of("first_name","email","purchases")).phone("+11112223333").userAliases(List.of(UsersExportIdsCreateBodyUserAliasesItem.builder().aliasLabel("example_label").aliasName("example_alias").build())).build()` |
...
Client client = Client
                ...
                .build();
Map<?, ?> res = client.users().export().ids().create(CreateRequest
                .builder()
                .data(UsersExportIdsCreateBody
                      .builder()
                      .brazeId("braze_identifier")
                      .deviceId("1234567")
                      .emailAddress("example@braze.com")
                      .externalIds(List.of(
                                       "user_identifier1",
                                       "user_identifier2"
                                   ))
