...
package com.yourorg.brazejava.resources.users.export.globalcontrolgroup;
...
public class GlobalControlGroupClient {
    protected final BaseClient baseClient;

    public GlobalControlGroupClient(BaseClient baseClient) {
