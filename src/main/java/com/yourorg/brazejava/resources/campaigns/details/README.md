...
### Export Campaign Details <a name="list"></a>
...
Client client = Client
                ...
                .build();
Map<?, ?> res = client.campaigns().details().list(ListRequest
                .builder()
