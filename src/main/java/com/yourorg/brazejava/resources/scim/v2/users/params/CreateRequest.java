...
public final class CreateRequest {
    private final Optional<ScimV2UsersCreateBody> data;

    private CreateRequest(
        Optional<ScimV2UsersCreateBody> data
    ) {
        this.data = data;
    }
    ...
    @JsonProperty("data")
    @JsonInclude(JsonInclude.Include.NON_ABSENT)
    public ScimV2UsersCreateBody getData() {
    ...
    public static final class Builder {
        private Optional<ScimV2UsersCreateBody> data = Optional.empty();
         ...
         */
        @JsonSetter("data")
        public Builder data(ScimV2UsersCreateBody data) {
            this.data = Optional.ofNullable(data);

            return this;
        }

        public Builder data(Optional<ScimV2UsersCreateBody> data) {
            this.data = data;
            return this;
        }
