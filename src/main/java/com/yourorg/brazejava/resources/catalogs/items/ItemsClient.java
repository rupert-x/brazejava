...
package com.yourorg.brazejava.resources.catalogs.items;
...
public class ItemsClient {
    ...
    public ItemsClient(BaseClient baseClient) {
    ...
    */
    public Map<?, ?> delete1(Delete1Request request) {
        return delete1(request, null);
    }
    ...
    * DELETE /catalogs/{catalog_name}/items/{item_id}
    */
    public Map<?, ?> delete1(Delete1Request request, RequestOptions requestOptions) {
        ...
        try {
            ...
            .addPathParam("catalog_name", request.getCatalogName())
            .addPathParam("item_id", request.getItemId())
            .method("DELETE")
            .addAuth(baseClient.getAuth("BearerAuth"))
            .execute();
            return ResponseHandler.processJsonResponse(response, new TypeReference<Map<?, ?>>() {});
    ...
    */
    public Map<?, ?> patch(PatchRequest request) {
    ...
    * PATCH /catalogs/{catalog_name}/items
    */
    public Map<?, ?> patch(PatchRequest request, RequestOptions requestOptions) {
    ...
    */
    public Map<?, ?> patch1(Patch1Request request) {
        return patch1(request, null);
    }
    ...
    * PATCH /catalogs/{catalog_name}/items/{item_id}
    */
    public Map<?, ?> patch1(Patch1Request request, RequestOptions requestOptions) {
    ...
    */
    public Map<?, ?> create1(Create1Request request) {
        return create1(request, null);
    }
    ...
    * POST /catalogs/{catalog_name}/items/{item_id}
    */
    public Map<?, ?> create1(Create1Request request, RequestOptions requestOptions) {
    ...
    */
    public Map<?, ?> update1(Update1Request request) {
        return update1(request, null);
    }
    ...
    * PUT /catalogs/{catalog_name}/items/{item_id}
    */
    public Map<?, ?> update1(Update1Request request, RequestOptions requestOptions) {
