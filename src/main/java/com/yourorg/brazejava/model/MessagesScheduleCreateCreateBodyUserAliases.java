...
/**
 * MessagesScheduleCreateCreateBodyUserAliases
 */
@JsonInclude(JsonInclude.Include.NON_ABSENT)
@JsonDeserialize(builder = MessagesScheduleCreateCreateBodyUserAliases.Builder.class)
public final class MessagesScheduleCreateCreateBodyUserAliases {
    private final Optional<String> aliasLabel;
    private final Optional<String> aliasName;

    private MessagesScheduleCreateCreateBodyUserAliases(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof MessagesScheduleCreateCreateBodyUserAliases &&
               equalTo((MessagesScheduleCreateCreateBodyUserAliases) other);
    }

    private boolean equalTo(MessagesScheduleCreateCreateBodyUserAliases other) {
        return
    ...
    public String toString() {
        return "MessagesScheduleCreateCreateBodyUserAliases{" +
    ...
    public static final class Builder {
        ...
        public Builder from(MessagesScheduleCreateCreateBodyUserAliases other) {
        ...
        public MessagesScheduleCreateCreateBodyUserAliases build() {
            return new MessagesScheduleCreateCreateBodyUserAliases(
                       aliasLabel,
                       aliasName
                   );
        }
