...
/**
 * MessagesSendCreateBodyUserAliases
 */
@JsonInclude(JsonInclude.Include.NON_ABSENT)
@JsonDeserialize(builder = MessagesSendCreateBodyUserAliases.Builder.class)
public final class MessagesSendCreateBodyUserAliases {
    private final Optional<String> aliasLabel;
    private final Optional<String> aliasName;

    private MessagesSendCreateBodyUserAliases(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof MessagesSendCreateBodyUserAliases &&
               equalTo((MessagesSendCreateBodyUserAliases) other);
    }

    private boolean equalTo(MessagesSendCreateBodyUserAliases other) {
        return
    ...
    public String toString() {
        return "MessagesSendCreateBodyUserAliases{" +
    ...
    public static final class Builder {
        ...
        public Builder from(MessagesSendCreateBodyUserAliases other) {
        ...
        public MessagesSendCreateBodyUserAliases build() {
            return new MessagesSendCreateBodyUserAliases(
                       aliasLabel,
                       aliasName
                   );
        }
