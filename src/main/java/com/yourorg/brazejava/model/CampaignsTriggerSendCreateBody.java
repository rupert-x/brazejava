...
/**
 * CampaignsTriggerSendCreateBody
 */
@JsonInclude(JsonInclude.Include.NON_ABSENT)
@JsonDeserialize(builder = CampaignsTriggerSendCreateBody.Builder.class)
public final class CampaignsTriggerSendCreateBody {
    private final Optional<CampaignsTriggerSendCreateBodyAudience> audience;
    private final Optional<Boolean> broadcast;
    private final Optional<String> campaignId;
    private final Optional<List<CampaignsTriggerSendCreateBodyRecipientsItem>> recipients;
    private final Optional<String> sendId;
    private final Optional<Map<?, ?>> triggerProperties;

    private CampaignsTriggerSendCreateBody(
        Optional<CampaignsTriggerSendCreateBodyAudience> audience,
        Optional<Boolean> broadcast,
        Optional<String> campaignId,
        Optional<List<CampaignsTriggerSendCreateBodyRecipientsItem>> recipients,
    ...
    @JsonInclude(JsonInclude.Include.NON_ABSENT)
    public CampaignsTriggerSendCreateBodyAudience getAudience() {
    ...
    @JsonInclude(JsonInclude.Include.NON_ABSENT)
    public List<CampaignsTriggerSendCreateBodyRecipientsItem> getRecipients() {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CampaignsTriggerSendCreateBody &&
               equalTo((CampaignsTriggerSendCreateBody) other);
    }

    private boolean equalTo(CampaignsTriggerSendCreateBody other) {
        return
    ...
    public String toString() {
        return "CampaignsTriggerSendCreateBody{" +
               "audience=" + audience +
               "broadcast=" + broadcast +
    ...
    public static final class Builder {
        private Optional<CampaignsTriggerSendCreateBodyAudience> audience = Optional.empty();
        private Optional<Boolean> broadcast = Optional.empty();
        private Optional<String> campaignId = Optional.empty();
        private Optional<List<CampaignsTriggerSendCreateBodyRecipientsItem>> recipients = Optional.empty();
        private Optional<String> sendId = Optional.empty();
        private Optional<Map<?, ?>> triggerProperties = Optional.empty();

        private Builder() {}

        public Builder from(CampaignsTriggerSendCreateBody other) {
         ...
         */
        @JsonSetter("audience")
        public Builder audience(CampaignsTriggerSendCreateBodyAudience audience) {
            this.audience = Optional.ofNullable(audience);

            return this;
        }

        public Builder audience(Optional<CampaignsTriggerSendCreateBodyAudience> audience) {
            this.audience = audience;
            return this;
        }
        ...
        public Builder recipients(List<CampaignsTriggerSendCreateBodyRecipientsItem> recipients) {
            this.recipients = Optional.ofNullable(recipients);

            return this;
        }

        public Builder recipients(Optional<List<CampaignsTriggerSendCreateBodyRecipientsItem>> recipients) {
            this.recipients = recipients;
            return this;
        }
        ...
        public CampaignsTriggerSendCreateBody build() {
            return new CampaignsTriggerSendCreateBody(
                       audience,
                       broadcast,
                       campaignId,
                       recipients,
