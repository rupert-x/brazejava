...
/**
 * CampaignsTriggerSendCreateBodyRecipientsItemUserAlias
 */
@JsonInclude(JsonInclude.Include.NON_ABSENT)
@JsonDeserialize(builder = CampaignsTriggerSendCreateBodyRecipientsItemUserAlias.Builder.class)
public final class CampaignsTriggerSendCreateBodyRecipientsItemUserAlias {
    private final Optional<String> aliasLabel;
    private final Optional<String> aliasName;

    private CampaignsTriggerSendCreateBodyRecipientsItemUserAlias(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CampaignsTriggerSendCreateBodyRecipientsItemUserAlias &&
               equalTo((CampaignsTriggerSendCreateBodyRecipientsItemUserAlias) other);
    }

    private boolean equalTo(CampaignsTriggerSendCreateBodyRecipientsItemUserAlias other) {
        return
    ...
    public String toString() {
        return "CampaignsTriggerSendCreateBodyRecipientsItemUserAlias{" +
    ...
    public static final class Builder {
        ...
        public Builder from(CampaignsTriggerSendCreateBodyRecipientsItemUserAlias other) {
        ...
        public CampaignsTriggerSendCreateBodyRecipientsItemUserAlias build() {
            return new CampaignsTriggerSendCreateBodyRecipientsItemUserAlias(
                       aliasLabel,
                       aliasName
                   );
        }
