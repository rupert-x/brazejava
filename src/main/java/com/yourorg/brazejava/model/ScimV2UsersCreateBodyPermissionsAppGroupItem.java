...
@JsonDeserialize(builder = ScimV2UsersCreateBodyPermissionsAppGroupItem.Builder.class)
public final class ScimV2UsersCreateBodyPermissionsAppGroupItem {
    private final Optional<String> appGroupName;
    private final Optional<List<String>> appGroupPermissions;
    private final Optional<List<ScimV2UsersCreateBodyPermissionsAppGroupItemTeamItem>> team;

    private ScimV2UsersCreateBodyPermissionsAppGroupItem(
        Optional<String> appGroupName,
        Optional<List<String>> appGroupPermissions,
        Optional<List<ScimV2UsersCreateBodyPermissionsAppGroupItemTeamItem>> team
    ) {
    ...
    @JsonProperty("team")
    @JsonInclude(JsonInclude.Include.NON_ABSENT)
    public List<ScimV2UsersCreateBodyPermissionsAppGroupItemTeamItem> getTeam() {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ScimV2UsersCreateBodyPermissionsAppGroupItem &&
               equalTo((ScimV2UsersCreateBodyPermissionsAppGroupItem) other);
    }

    private boolean equalTo(ScimV2UsersCreateBodyPermissionsAppGroupItem other) {
        return
    ...
    public String toString() {
        return "ScimV2UsersCreateBodyPermissionsAppGroupItem{" +
    ...
    public static final class Builder {
        ...
        private Optional<List<ScimV2UsersCreateBodyPermissionsAppGroupItemTeamItem>> team =
            Optional.empty();

        private Builder() {}

        public Builder from(ScimV2UsersCreateBodyPermissionsAppGroupItem other) {
         ...
         */
        @JsonSetter("team")
        public Builder team(List<ScimV2UsersCreateBodyPermissionsAppGroupItemTeamItem> team) {
            this.team = Optional.ofNullable(team);

            return this;
        }

        public Builder team(Optional<List<ScimV2UsersCreateBodyPermissionsAppGroupItemTeamItem>> team) {
            this.team = team;
            return this;
        }


        public ScimV2UsersCreateBodyPermissionsAppGroupItem build() {
            return new ScimV2UsersCreateBodyPermissionsAppGroupItem(
                       appGroupName,
                       appGroupPermissions,
                       team
                   );
