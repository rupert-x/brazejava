...
@JsonDeserialize(builder = UsersDeleteCreateBodyUserAliasesItem.Builder.class)
public final class UsersDeleteCreateBodyUserAliasesItem {
    private final Optional<String> aliasLabel;
    private final Optional<String> aliasName;

    private UsersDeleteCreateBodyUserAliasesItem(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UsersDeleteCreateBodyUserAliasesItem &&
               equalTo((UsersDeleteCreateBodyUserAliasesItem) other);
    }

    private boolean equalTo(UsersDeleteCreateBodyUserAliasesItem other) {
        return
    ...
    public String toString() {
        return "UsersDeleteCreateBodyUserAliasesItem{" +
    ...
    public static final class Builder {
        ...
        public Builder from(UsersDeleteCreateBodyUserAliasesItem other) {
        ...
        public UsersDeleteCreateBodyUserAliasesItem build() {
            return new UsersDeleteCreateBodyUserAliasesItem(
                       aliasLabel,
                       aliasName
                   );
        }
