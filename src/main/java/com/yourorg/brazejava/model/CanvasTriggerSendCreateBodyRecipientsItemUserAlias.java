...
/**
 * CanvasTriggerSendCreateBodyRecipientsItemUserAlias
 */
@JsonInclude(JsonInclude.Include.NON_ABSENT)
@JsonDeserialize(builder = CanvasTriggerSendCreateBodyRecipientsItemUserAlias.Builder.class)
public final class CanvasTriggerSendCreateBodyRecipientsItemUserAlias {
    private final Optional<String> aliasLabel;
    private final Optional<String> aliasName;

    private CanvasTriggerSendCreateBodyRecipientsItemUserAlias(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CanvasTriggerSendCreateBodyRecipientsItemUserAlias &&
               equalTo((CanvasTriggerSendCreateBodyRecipientsItemUserAlias) other);
    }

    private boolean equalTo(CanvasTriggerSendCreateBodyRecipientsItemUserAlias other) {
        return
    ...
    public String toString() {
        return "CanvasTriggerSendCreateBodyRecipientsItemUserAlias{" +
    ...
    public static final class Builder {
        ...
        public Builder from(CanvasTriggerSendCreateBodyRecipientsItemUserAlias other) {
        ...
        public CanvasTriggerSendCreateBodyRecipientsItemUserAlias build() {
            return new CanvasTriggerSendCreateBodyRecipientsItemUserAlias(
                       aliasLabel,
                       aliasName
                   );
        }
